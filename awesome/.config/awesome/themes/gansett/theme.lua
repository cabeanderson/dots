...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/gansett/icons"
--theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/gansett/wall.png"
...
function theme.vertical_wibox(s)
    ...
    s.dockheight = s.workarea.height
    s.dockwidth = (25 * s.workarea.width)/100

    s.myleftwibox = wibox({ screen = s, x=0, y=s.workarea.height/2 - s.dockheight/2, width = s.dockwidth, height = s.dockheight, fg = theme.fg_normal, bg = barcolor2, ontop = true, visible = true, type = "dock" })
    ...
    tag.connect_signal("property::selected", function(t)
        ...
        s.myleftwibox.width = s.dockwidth
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
--    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(11), bg = gears.color.create_png_pattern(theme.panelbg) })
